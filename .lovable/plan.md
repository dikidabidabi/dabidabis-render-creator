...
## Tujuan
Mengatur ulang dimensi pada Slide Detail agar seluruh ukuran ditempatkan di sisi kiri dan kanan denah, sejajar dengan perimeter lantai terluar.
...
- Tampilkan rantai dimensi ruang pada kedua sisi denah, tepat 1 meter dari perimeter lantai terluar.
- Tampilkan dimensi bentang grid struktur pada kedua sisi denah, tepat 2 meter dari perimeter lantai terluar.
- Hilangkan dimensi grid yang saat ini muncul di sisi atas, sehingga dimensi ruang dan grid mengikuti aturan sisi kiri/kanan yang sama.
...
## Verifikasi
- Uji Slide Detail dengan lantai dan grid biasa: dimensi ruang berada 1 m, dimensi grid 2 m, di kiri dan kanan.
