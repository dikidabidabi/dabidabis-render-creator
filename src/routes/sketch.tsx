  ...
  const SidePanel = (
    <aside
      className={cn(
        ...
        fullscreen ? "flex flex-col overflow-hidden" : "space-y-5 p-5",
    ...
    >
      {fullscreen && (
        <div
          {...sideDragHandlers}
          className="flex cursor-move select-none items-center justify-between gap-2 border-b border-border/60 px-3 py-2 touch-none"
        >
      ...
      <div className={cn(fullscreen ? "space-y-5 overflow-y-auto p-4" : "")}>
